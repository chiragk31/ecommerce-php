                        ...
                        while($user_fetch=mysqli_fetch_assoc($user_result)){
                            ...
                            echo "
                                ...
                                <td>
                                    ...
                                    <button name='delete' class='btn' style='background: red;'><a href='delete.php?deleteid=$user_fetch[Order_id]' style='text-decoration: none;color: #ffd8d8;'>Delete</a></button>
