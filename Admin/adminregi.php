...
<input type="checkbox" id="check">
    ...
    ?>
    <a href="Registration.php" class="regiadmin">Register an Admin</a>
        ...
        <div class="row">
            <div class="col-lg-12">
                <table class="table text-center ">
                    ...
                    <tbody>
                    <?php
                        $query1="SELECT * FROM `admin_login`";
                        ...
                        while($user_fetch=mysqli_fetch_assoc($user_result)){
                            echo "
                                ...
                                <td>$user_fetch[Admin_Name]</td>
                                <td>$user_fetch[Admin_Password]</td>
                                ...
                                echo"
                                    ...
                                    <button name='delete' class='btn' style='background: red;'><a href='adminregi.php?deleteid=$user_fetch[Id]' style='text-decoration: none;color: #ffd8d8;'>Delete</a></button>
                                    <button name='update' class='btn' style='background: blue;'><a href='update.php?updateid=$user_fetch[Id]' style='text-decoration: none;color: #ffd8d8;'>Update</a></button>
